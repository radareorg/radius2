...
const SBPF_SF_REGISTER_END: u64 = SBPF_SF_REGISTER_OFFSET + 0x8;
const SBPF_SHADOW_REGISTER_OFFSET: u64 = SBPF_SF_REGISTER_END;
const SBPF_SHADOW_REGISTER_END: u64 = SBPF_SHADOW_REGISTER_OFFSET + 0x8;
